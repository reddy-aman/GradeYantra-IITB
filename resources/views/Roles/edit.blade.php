...
<div class="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 bg-white">
    <x-slot name="header">
        ...
        Roles /<a class="text-blue-700" href="{{route('permissions.index')}}"></a>
        </h2>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">    
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="name" value="{{old('name',$role->name)}}" placeholder="Enter Role Name" class=" text-sm rounded-lg  w-5/12 ">
                        @error('name')
                   ...
                   <label for="permission-{{$permission->id}}">{{$permission->name}}</label>
                    ...
                    <button class="rounded text-sm bg-slate-700 px-4 mt-2 py-3 text-white hover:bg-green-950 hover:shadow-lg transition duration-300 ease-in-out">
                        Update
                    </button>
